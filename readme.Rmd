...
ecomix is a package to implement statisitical models on multivariate species data. Two main type of finite mixture models are avaliable which either model at species level (Species Archetype Models) or site level (Region of Common Profile). 
