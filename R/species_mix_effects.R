...
#' @param boot.object A species_mix.bootsrap object. Default is NULL, no standard
...
#' plot(eff.df,fm1)
#'}
"plot.species_mix_effects_data" <- function(x, object, boot.object = NULL,
                                              nboot = 0,
                                              type='response',
                                              response.var = NULL,
                                              CI = c(0.025, 0.975),
  ...
  partial.preds <- suppressMessages(lapply(xnew, function(ii) predict(object=object, boot.object=boot.object,
