...
```{r archetype predictions,echo=FALSE,fig.width= 4, fig.height= 8,fig.cap="Figure 7. The predicted probability of each species archetype across the simulated environment and the standard error of the predictions generated based on the Bayesian bootstrap."}
# env.df$Time <- factor("Day",levels=c("Day","Night"))
# sam3_pred <- predict(sam_fit, sam_boot, newdata=env.df)
