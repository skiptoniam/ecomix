...
testthat::test_that('species_mix negative binomial', {
  ...
  ss <- 1
  testthat::expect_length(ecomix:::apply_glm_sam_inits(ss, y, X, site_spp_weights, offset, y_is_na, disty),3)
  ...
  testthat::expect_length(tmp <- ecomix:::get_starting_values_sam(y, X, spp_weights, site_spp_weights, offset, y_is_na, G, S, disty, control),8)
  #
  # #get the taus
