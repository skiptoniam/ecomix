...
testthat::test_that('species_mix negative binomial', {
  ...
  # sp_form_int <- ~ 1
  # testthat::expect_warning(fmnb1 <- species_mix(sam_form, sp_form_int, model_data, distribution = 'negative_binomial', n_mixtures=3, control = species_mix.control(quiet=TRUE,calculate_hessian_cpp = FALSE)))
